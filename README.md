...
Llamara3 is self-hosted female ollama powered personal assistant character AI that is actually useful, with extensive feature augmentations, that communicates to people via voice messages in an XMPP messenger (alike Whatsapp).
